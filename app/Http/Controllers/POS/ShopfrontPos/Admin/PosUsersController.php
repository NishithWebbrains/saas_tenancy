...
class PosUsersController extends Controller
{
    ...
    {
       return view('layouts.tenant.shopfrontpos.posusers');
    ...
    {
       //dd($tenants);
        return view('layouts.tenant.shopfrontpos.createuser');
    }
    ...
    public function storeuser(Request $request)
    {
        ...
        return redirect()->route('shopfrontpos.posusers', ['tenant' => $tenantId])
