...
class PosRolesController extends Controller
{
    ...
    public function view()  
    {
       ...
       return view('swiftpos::layouts.roles');
    ...
    {
       //dd($tenants);
        return view('swiftpos::layouts.createrole');
    }
    ...
    public function addrole(Request $request)
    {
        ...
        return redirect()->route('swiftpos.roles', ['tenant' => $tenantId])
    ...
    public function roledata()
    {
        ...
        return DataTables::of($roles)
            ...
            ->addColumn('actions', function ($role) use ($tenantId) {
                ...
                $editUrl = '';
                $permUrl = route('swiftpos.permission', ['tenant' => $tenantId, 'role' => $role->id]);
