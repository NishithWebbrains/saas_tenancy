...
<div class="container">
    ...
    <a href="{{ route('abspos.roles', ['tenant' => $tenantId]) }}" class="btn btn-danger mb-3">← Back to Roles</a>

    <form id="permissionsForm" method="POST" action="{{ route('abspos.savepermissions', ['tenant' => $tenantId, 'role' => $roleId]) }}">
        @csrf
