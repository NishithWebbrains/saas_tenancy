<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
  ...
  <div class="sidebar-wrapper">
    <nav class="mt-2">
      ...
      @if(auth('abspos')->user()?->canAccess('dashboard','view'))
        <li class="nav-item menu-open">
          <a href="{{ route('abspos.dashboard', ['tenant' => $tenantId]) }}" class="nav-link active">
        ...
        <li class="nav-item menu-open">
          ...
          <a href="{{ route('abspos.posusers', ['tenant' => $tenantId]) }}" class="nav-link active">
            <i class="nav-icon bi bi-speedometer"></i>
            <p>Store Users</p>
          </a>
        </li>
        <li class="nav-item menu-open">
          ...
          <a href="{{ route('abspos.roles', ['tenant' => $tenantId]) }}" class="nav-link active">
            <i class="nav-icon bi bi-speedometer"></i>
            <p>Roles</p>
          </a>
        </li>
