...
class PermissionController extends Controller
{
    ...
    public function view(Request $request)
    {
        ...
        return view('abspos::layouts.permission', compact('role', 'menus', 'permissions', 'assignedPermissions'));
    }
    ...
    public function getPermission($tenantId, $roleId)
    {
        ...
        return view('abspos::roles.permission', array_merge($data, ['tenantId' => $tenantId]));
    }
