...
class PosRolesController extends Controller
{
    ...
    public function view()  
    {
       ...
       return view('shopfrontpos::layouts.roles');
    ...
    {
       //dd($tenants);
        return view('shopfrontpos::layouts.createrole');
    }
    ...
    public function addrole(Request $request)
    {
        ...
        return redirect()->route('shopfrontpos.roles', ['tenant' => $tenantId])
    ...
    public function roledata()
    {
        ...
        return DataTables::of($roles)
            ...
            ->addColumn('actions', function ($role) use ($tenantId) {
                ...
                $editUrl = '';
                $permUrl = route('shopfrontpos.permission', ['tenant' => $tenantId, 'role' => $role->id]);
